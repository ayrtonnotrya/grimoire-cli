...
**Gemini Developer API:** Set the GEMINI\_API\_KEY or GOOGLE\_API\_KEY.
It will automatically be picked up by the client. It’s recommended that you
set only one of those variables, but if both are set, GOOGLE\_API\_KEY takes
precedence.
...
**Gemini API on Vertex AI:** Set GOOGLE\_GENAI\_USE\_VERTEXAI,
GOOGLE\_CLOUD\_PROJECT and GOOGLE\_CLOUD\_LOCATION, as shown below:
...
### Close a client[¶](#close-a-client "Link to this heading")
...
### Client context managers[¶](#client-context-managers "Link to this heading")
...
### Faster async client option: Aiohttp[¶](#faster-async-client-option-aiohttp "Link to this heading")
...
### Proxy[¶](#proxy "Link to this heading")
...
If you need socks5 proxy, httpx [supports](https://www.python-httpx.org/advanced/proxies/#socks)
...
### Custom base url[¶](#custom-base-url "Link to this heading")
...
### with text content input (text output)[¶](#with-text-content-input-text-output "Link to this heading")
...
### with text content input (image output)[¶](#with-text-content-input-image-output "Link to this heading")
...
### List Base Models (Asynchronous)[¶](#list-base-models-asynchronous "Link to this heading")
...
### Automatic Python function Support:[¶](#automatic-python-function-support "Link to this heading")
...
### Disabling automatic function calling[¶](#disabling-automatic-function-calling "Link to this heading")
...
### Manually declare and invoke a function for function calling[¶](#manually-declare-and-invoke-a-function-for-function-calling "Link to this heading")
...
### Function calling with `ANY` tools config mode[¶](#function-calling-with-any-tools-config-mode "Link to this heading")
...
### Model Context Protocol (MCP) support (experimental)[¶](#model-context-protocol-mcp-support-experimental "Link to this heading")
...
### JSON Schema support[¶](#json-schema-support "Link to this heading")
...
### Pydantic Model Schema support[¶](#pydantic-model-schema-support "Link to this heading")
...
### Text Response[¶](#text-response "Link to this heading")
...
## Generate Content (Synchronous Streaming)[¶](#generate-content-synchronous-streaming "Link to this heading")
...
### Streaming for text content[¶](#streaming-for-text-content "Link to this heading")
...
### Streaming for image content[¶](#streaming-for-image-content "Link to this heading")
...
## Generate Content (Asynchronous Non Streaming)[¶](#generate-content-asynchronous-non-streaming "Link to this heading")
...
## Generate Content (Asynchronous Streaming)[¶](#generate-content-asynchronous-streaming "Link to this heading")
...
### Compute Tokens[¶](#compute-tokens "Link to this heading")
...
### Count Tokens (Asynchronous)[¶](#count-tokens-asynchronous "Link to this heading")
...
### Local Count Tokens[¶](#local-count-tokens "Link to this heading")
...
### Local Compute Tokens[¶](#local-compute-tokens "Link to this heading")
...
### Generate Images[¶](#generate-images "Link to this heading")
...
### Upscale Image[¶](#upscale-image "Link to this heading")
...
### Edit Image[¶](#edit-image "Link to this heading")
...
### Generate Videos (Text to Video)[¶](#generate-videos-text-to-video "Link to this heading")
...
### Generate Videos (Image to Video)[¶](#generate-videos-image-to-video "Link to this heading")
...
### Generate Videos (Video to Video)[¶](#generate-videos-video-to-video "Link to this heading")
...
## Send Message (Synchronous Non-Streaming)[¶](#send-message-synchronous-non-streaming "Link to this heading")
...
## Send Message (Synchronous Streaming)[¶](#send-message-synchronous-streaming "Link to this heading")
...
## Send Message (Asynchronous Non-Streaming)[¶](#send-message-asynchronous-non-streaming "Link to this heading")
...
## Send Message (Asynchronous Streaming)[¶](#send-message-asynchronous-streaming "Link to this heading")
...
## Generate Content with Caches[¶](#generate-content-with-caches "Link to this heading")
...
## Use Tuned Model[¶](#use-tuned-model "Link to this heading")
...
### List Tuned Models (Asynchronous)[¶](#list-tuned-models-asynchronous "Link to this heading")
...
## Update Tuned Model[¶](#id5 "Link to this heading")
...
## Create[¶](#id6 "Link to this heading")
...
### Gemini Developer API[¶](#id7 "Link to this heading")
...
### List Batch Jobs with Pager[¶](#list-batch-jobs-with-pager "Link to this heading")
...
### List Batch Jobs (Asynchronous)[¶](#list-batch-jobs-asynchronous "Link to this heading")
...
### List Batch Jobs with Pager (Asynchronous)[¶](#list-batch-jobs-with-pager-asynchronous "Link to this heading")
...
## Delete[¶](#id8 "Link to this heading")
...
# Extra Request Body[¶](#extra-request-body "Link to this heading")
